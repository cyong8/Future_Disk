...
Room::Room(Ogre::SceneManager *mSceneMgr, Simulator *game_simulator)
{
	...
	position = Ogre::Vector3(0.0f, -width/4.0f, 0.0f);
	...
	height, width/2, 20, 20, true, 1, height/4, width/4, Ogre::Vector3::UNIT_Y);
...
// Front and Back Divisions
	...
	width/3, width/2, 20, 20, true, 1, width/4, height/4, Ogre::Vector3::UNIT_Y);
	...
	width/3, width/2, 20, 20, true, 1, width/4, width/4, Ogre::Vector3::UNIT_Y);
	...
	Ogre::Real fnSideWidth = width* Ogre::Math::Sqrt(2)/2;
	...
	fnSideWidth, width/2, 20, 20, true, 1, 5, 5, Ogre::Vector3::UNIT_Y);
